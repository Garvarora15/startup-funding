...
export default function PolicyModal({ isOpen, onClose, type, currentLanguage }: PolicyModalProps) {
  ...
  const getPrivacyContent = () => (
    <div className="space-y-4 font-sans text-xs text-[#2D1B4E] leading-relaxed">
      <div className="bg-[#F8F6FF] border border-[#E4DEF5] rounded-lg p-3.5 mb-4 flex items-start gap-3">
        <Lock className="w-5 h-5 text-[#6D28D9] shrink-0 mt-0.5" />
        <div>
          <h4 className="font-mono font-bold text-[10px] text-[#6D28D9] uppercase tracking-wide">Data Security Guarantee</h4>
          <p className="text-[11px] text-[#6D28D9] mt-0.5">We utilize local client-side memory storage (localStorage) and secure enterprise IBM Cloud architecture. Your startup's proprietary code, financial structures, and pitches are processed directly and never sold or shared.</p>
        </div>
      </div>

      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">1. Information We Collect</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">2. How We Use Your Data</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">3. Third-Party Integrations & AI Cloud Processing</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">4. Contact Information</h3>
      <p>
        For inquiries regarding our cryptographic data processing pipelines or to purge local localStorage cached items, please contact: <a href="mailto:garv26arora@gmail.com" className="text-[#6D28D9] underline font-bold">garv26arora@gmail.com</a>.
      </p>
    </div>
  );
  ...
  const getCookieContent = () => (
    <div className="space-y-4 font-sans text-xs text-[#2D1B4E] leading-relaxed">
      <div className="bg-[#F8F6FF] border border-[#E4DEF5] rounded-lg p-3.5 mb-4 flex items-start gap-3">
        <Info className="w-5 h-5 text-[#6D28D9] shrink-0 mt-0.5" />
        <div>
          <h4 className="font-mono font-bold text-[10px] text-[#6D28D9] uppercase tracking-wide">Zero Tracking Commitment</h4>
          <p className="text-[11px] text-[#6D28D9] mt-0.5">Startup Funding Hub does not utilize invasive advertising, cross-site tracking pixels, or commercial behavioral profiling scripts. Your preferences are stored cleanly on your device.</p>
        </div>
      </div>

      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">1. What are Cookies and Local Storage?</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">2. How We Use Local Memory Storage</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">3. Managing and Opting Out</h3>
      <p>
  ...
  const getTermsContent = () => (
    <div className="space-y-4 font-sans text-xs text-[#2D1B4E] leading-relaxed">
      <div className="bg-[#F8F6FF] border border-[#E4DEF5] rounded-lg p-3.5 mb-4 flex items-start gap-3">
        <FileText className="w-5 h-5 text-[#6D28D9] shrink-0 mt-0.5" />
        <div>
          <h4 className="font-mono font-bold text-[10px] text-[#6D28D9] uppercase tracking-wide">Enterprise Legal Framework</h4>
          <p className="text-[11px] text-[#6D28D9] mt-0.5">Please review these terms carefully before utilizing our automated matching algorithms. These terms protect your intellectual property and outline correct usage guidelines.</p>
        </div>
      </div>

      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">1. Description of Services</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">2. No Financial or Legal Representation</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">3. Intellectual Property Rights</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">4. Limitation of Liability</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-[#6D28D9] uppercase tracking-wide">5. Governing Law</h3>
      <p>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      {/* Backdrop */}
      <div 
        className="absolute inset-0 bg-[#1E1533]/50 backdrop-blur-sm transition-opacity" 
        onClick={onClose}
      />
      
      {/* Modal Dialog */}
      <div className="relative bg-white border border-[#E4DEF5] rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] flex flex-col z-10 overflow-hidden transform transition-all">
        
        {/* Header */}
        <div className="px-6 py-4 bg-[#F8F6FF] border-b border-[#E4DEF5] flex items-center justify-between">
          <div className="flex items-center gap-2">
            {type === 'privacy' && <Shield className="w-5 h-5 text-[#6D28D9]" />}
            {type === 'cookies' && <Info className="w-5 h-5 text-[#6D28D9]" />}
            {type === 'terms' && <FileText className="w-5 h-5 text-[#6D28D9]" />}
            <h2 className="font-sans font-extrabold text-[#1E1533] text-sm md:text-base leading-none">
              {getTitle()}
            </h2>
          </div>
          <button 
            onClick={onClose}
            className="p-1.5 rounded-lg border border-[#E4DEF5] bg-white text-[#6D28D9] hover:bg-[#EDE6FB] transition cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="px-6 py-3.5 bg-[#F8F6FF] border-t border-[#E4DEF5] flex items-center justify-between">
          <span className="font-mono text-[9px] text-[#8B85A6]">
            LAST UPDATED: JUNE 2026 ● © {currentYear} STARTUP FUNDING HUB
          </span>
          <button
            onClick={onClose}
            className="px-4 py-1.5 rounded-lg bg-[#6D28D9] text-white hover:bg-[#4C1D95] text-xs font-mono font-bold transition cursor-pointer"
          >
            {t.acknowledge}
          </button>
        </div>
