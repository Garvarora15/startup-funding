...
export default function PolicyModal({ isOpen, onClose, type, currentLanguage }: PolicyModalProps) {
  ...
  const getPrivacyContent = () => (
    <div className="space-y-4 font-sans text-xs text-slate-700 leading-relaxed">
      <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-3.5 mb-4 flex items-start gap-3">
        <Lock className="w-5 h-5 text-indigo-700 shrink-0 mt-0.5" />
        <div>
          <h4 className="font-mono font-bold text-[10px] text-indigo-700 uppercase tracking-wide">Data Security Guarantee</h4>
          <p className="text-[11px] text-indigo-700 mt-0.5">We utilize local client-side memory storage (localStorage) and secure enterprise IBM Cloud architecture. Your startup's proprietary code, financial structures, and pitches are processed directly and never sold or shared.</p>
        </div>
      </div>

      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">1. Information We Collect</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">2. How We Use Your Data</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">3. Third-Party Integrations & AI Cloud Processing</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">4. Contact Information</h3>
      <p>
        For inquiries regarding our cryptographic data processing pipelines or to purge local localStorage cached items, please contact: <a href="mailto:garv26arora@gmail.com" className="text-indigo-700 underline font-bold">garv26arora@gmail.com</a>.
      </p>
    </div>
  );
  ...
  const getCookieContent = () => (
    <div className="space-y-4 font-sans text-xs text-slate-700 leading-relaxed">
      <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-3.5 mb-4 flex items-start gap-3">
        ...
        <div>
          <h4 className="font-mono font-bold text-[10px] text-indigo-700 uppercase tracking-wide">Zero Tracking Commitment</h4>
          <p className="text-[11px] text-indigo-700 mt-0.5">Startup Funding Hub does not utilize invasive advertising, cross-site tracking pixels, or commercial behavioral profiling scripts. Your preferences are stored cleanly on your device.</p>
        </div>
      </div>

      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">1. What are Cookies and Local Storage?</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">2. How We Use Local Memory Storage</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">3. Managing and Opting Out</h3>
      <p>
  ...
  const getTermsContent = () => (
    <div className="space-y-4 font-sans text-xs text-slate-700 leading-relaxed">
      <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-3.5 mb-4 flex items-start gap-3">
        ...
        <div>
          <h4 className="font-mono font-bold text-[10px] text-indigo-700 uppercase tracking-wide">Enterprise Legal Framework</h4>
          <p className="text-[11px] text-indigo-700 mt-0.5">Please review these terms carefully before utilizing our automated matching algorithms. These terms protect your intellectual property and outline correct usage guidelines.</p>
        </div>
      </div>

      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">1. Description of Services</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">2. No Financial or Legal Representation</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">3. Intellectual Property Rights</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">4. Limitation of Liability</h3>
      <p>
      ...
      <h3 className="font-mono font-bold text-[11px] text-indigo-700 uppercase tracking-wide">5. Governing Law</h3>
      <p>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Dialog */}
      <div className="relative bg-white border border-indigo-100 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] flex flex-col z-10 overflow-hidden transform transition-all">
        
        {/* Header */}
        <div className="px-6 py-4 bg-indigo-50 border-b border-indigo-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            {type === 'privacy' && <Shield className="w-5 h-5 text-indigo-700" />}
            {type === 'cookies' && <Info className="w-5 h-5 text-indigo-700" />}
            {type === 'terms' && <FileText className="w-5 h-5 text-indigo-700" />}
            <h2 className="font-sans font-extrabold text-slate-900 text-sm md:text-base leading-none">
              {getTitle()}
            </h2>
          </div>
          <button 
            onClick={onClose}
            className="p-1.5 rounded-lg border border-indigo-100 bg-white text-indigo-700 hover:bg-indigo-50 transition cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="px-6 py-3.5 bg-indigo-50 border-t border-indigo-100 flex items-center justify-between">
          <span className="font-mono text-[9px] text-slate-400">
            LAST UPDATED: JUNE 2026 ● © {currentYear} STARTUP FUNDING HUB
          </span>
          <button
            onClick={onClose}
            className="px-4 py-1.5 rounded-lg bg-indigo-700 text-white hover:bg-indigo-800 text-xs font-mono font-bold transition cursor-pointer"
          >
            {t.acknowledge}
          </button>
        </div>
