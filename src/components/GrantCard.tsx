...
export default function GrantCard({
  ...
  return (
    <div className="bg-[#131A2E] border border-[#26314D] rounded-[20px] p-5 shadow-sm hover:border-[#3B82F6] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden flex flex-col justify-between text-[#F1F5F9]">
      {/* Visual Accent Bar */}
      ...
      <div>
            ...
            <button
              ...
              className={`p-2 rounded-xl border transition-all duration-200 cursor-pointer flex items-center justify-center hover:scale-110 active:scale-95 ${
                isFavorite 
                  ...
                  : 'bg-[#151D33] border-[#26314D] text-[#94A3B8] hover:bg-[#1B2440] hover:text-[#3B82F6]'
              }`}
        ...
        <div className="flex flex-wrap gap-1.5 my-3">
          <span className="bg-[#151D33] text-[#3B82F6] border border-[#26314D] text-[11px] font-semibold px-2.5 py-1 rounded-lg">
            💰 {grant.amount_display}
          </span>
          <span className="bg-[#1B2440] text-[#2563EB] border border-[#26314D] text-[10px] font-mono px-2.5 py-1 rounded-full">
        ...
        <div className="flex items-center gap-2 mb-3.5">
          <button
            ...
            disabled={ttsLoading}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#26314D] bg-[#0F1526] hover:bg-[#1B2440] hover:scale-[1.03] active:scale-[0.97] text-[#3B82F6] transition-all duration-200 text-[10.5px] font-mono font-bold cursor-pointer disabled:opacity-50 disabled:hover:scale-100"
          >
            {ttsLoading ? (
      ...
      <div>
        ...
        <div className="border-t border-[#26314D] pt-3 mt-2">
          <button
          ...
          {expanded && (
            <div className="mt-3 space-y-2 bg-[#0F1526] p-3.5 rounded-xl border border-[#26314D] text-xs">
              <div>
        ...
        {/* Action Bar */}
        <div className="flex gap-1.5 sm:gap-2 border-t border-[#26314D] pt-3 sm:pt-4 mt-3 sm:mt-4 text-[10.5px] sm:text-xs font-mono">
          <button
            ...
            className={`flex-[2] flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-2 sm:py-2.5 rounded-xl border font-semibold transition-all duration-200 cursor-pointer hover:scale-[1.02] active:scale-[0.98] ${
              isSelectedForProposal
                ...
                : 'border-[#26314D] bg-[#151D33] text-[#3B82F6] hover:bg-[#1B2440] hover:shadow-sm'
            }`}
          >
          ...
          <a
            ...
            className="flex-1 flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-3.5 py-2 sm:py-2.5 rounded-xl border border-[#26314D] bg-[#151D33] text-slate-200 hover:bg-[#1B2440] hover:text-[#F1F5F9] hover:border-[#3B82F6] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
