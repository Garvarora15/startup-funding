...
export default function Footer({ currentLanguage, onOpenPolicy }: FooterProps) {
  ...
  return (
    <footer id="app-footer" className="bg-white text-slate-800 border-t border-slate-200 mt-12">
      <div className="max-w-[1536px] mx-auto px-6 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-12">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#000054] border border-[#000054]">
                <Cpu className="w-4 h-4 text-white" />
              </div>
              <span className="font-display italic font-bold text-xl tracking-tight text-[#000054]">Startup Funding Hub</span>
              <span className="bg-[#000054] text-white text-[9px] font-mono font-bold px-2 py-0.5 rounded uppercase border border-[#000054]">
                IBM Granite
              </span>
            </div>
          ...
          <div className="md:col-span-4 space-y-4">
            <h4 className="font-mono text-[10px] font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5">
              <Terminal className="w-3.5 h-3.5" />
              <span>SYSTEM ARCHITECTURE</span>
            </h4>
            <div className="space-y-2 text-xs font-mono text-white">
              <div className="flex items-center gap-2 bg-[#000054] px-3 py-2 rounded-lg border border-[#000054]">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs">
              <li className="flex items-center gap-2 text-slate-700">
                ...
                <a href="mailto:garv26arora@gmail.com" className="hover:underline hover:text-[#000054] transition">
                  garv26arora@gmail.com
                </a>
              </li>
              <li className="pt-2 border-t border-slate-200 text-slate-600 leading-relaxed font-sans">
                <div className="flex items-center gap-1.5 flex-wrap">
                  <span>Created by</span>
                  <strong className="text-[#000054] font-semibold">Garv Arora</strong>
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="text-[10px] font-mono text-slate-500 tracking-wide">
            © {currentYear} STARTUP FUNDING HUB. DESIGNED & DEVELOPED BY <span className="text-[#000054] font-bold">GARV ARORA</span>.
          </div>
          <div className="flex flex-wrap gap-4 text-[10px] font-mono text-slate-500">
            <button 
              onClick={() => onOpenPolicy('privacy')} 
              className="hover:text-[#000054] transition cursor-pointer font-mono text-[10px] bg-transparent border-none p-0 outline-none"
            >
              PRIVACY POLICY
            </button>
            <span>●</span>
