...
![IBM Granite](https://img.shields.io/badge/Model-granite--3--3--8b--instruct-052FAD?style=flat-square&logo=ibm&logoColor=white)
...
The app connects to **IBM Watsonx.ai** using the `ibm/granite-3-3-8b-instruct` model to power a multilingual AI funding strategist, eligibility scoring engine, pitch generator, and proposal drafter — all in one place.
...
| **AI Model** | IBM Granite | `granite-3-3-8b-instruct` | Chat, proposals, pitches |
